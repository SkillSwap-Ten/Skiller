  ...
  return (
    <DivContent>
      <Form onSubmit={handleSubmit}>
        <Div>
          <Label htmlFor="id" text="ID del Usuario" />
          <Input placeholder="001..." readOnly type="number" name="id" id="id" value={form.id} onChange={handleChange} required />
        </Div>
        ...
        <Div>
          ...
          <Input placeholder="ejemplo@correo.com" readOnly type="email" name="email" id="email" value={form.email} onChange={handleChange} required />
        </Div>
        ...
        <Div>
          <Label htmlFor="idStateUser" text="Estado del Usuario" />
          <Select title="idStateUser" name="idStateUser" ariaLabel="idStateUser" id="idStateUser" value={form.idStateUser! || ""} onChange={handleChange}>
        ...
        <Div>
          <Label htmlFor="idRoleUser" text="Rol del Usuario" />
          <Select title="idRoleUser" name="idRoleUser" ariaLabel="idRoleUser" id="idRoleUser" value={form.idRoleUser! || ""} onChange={handleChange}>
            <option value={0} disabled>Selecciona una opción...</option>
        ...
        <Div>
          ...
          <Input type="date" name="suspensionDate" id="suspensionDate" value={form.suspensionDate ?? ""} onChange={handleChange} />
        </Div>

        <Div>
          <Label htmlFor="reactivationDate" text="Fecha de Reactivación" />
          <Input type="date" name="reactivationDate" id="reactivationDate" value={form.reactivationDate ?? ""} onChange={handleChange} />
        </Div>
